...
void AssetLoader::Init() //doing it manually because, actually I don't know why
{
	...
	Texture2D::sptr floor = Texture2D::LoadFromFile("image/Space.png");
	...
	//Fire Enemy
	/*VertexArrayObject::sptr FE_Mesh = ObjLoader::LoadFromFile("model/sphear.obj");
	Texture2D::sptr FE_Tex = Texture2D::LoadFromFile("image/corona_bk.png");
//	Texture2D::sptr noSpec = Texture2D::LoadFromFile("image/grassSpec.png");
